...
CloseBtn.Position = UDim2.new(0.93, 0, 0.0358126722, 0)
...
UIGradient.Parent = CloseBtn

CloseBtn.MouseEnter:Connect(function()
    TweenService:Create(UIGradient, TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
